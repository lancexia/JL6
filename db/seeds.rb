...
create_jos = for i in 1..10 do
  Job.create!([title: "行政助手.#{i}", description: "這是用種子建立的第 #{i} 個Public工作", wage_upper_bound: rand(100..200)*100, wage_lower_bound: rand(10..49)*100, is_hidden: "false", companyname: "柳叶公司", location: "上海", contact_email:"tget@162.com"])
end
